...
public class CCWDataFactory {
	...
	//			while(resultOwner.hasNext(handler.getMonitor()))
				{
		    		...
		    		CCW_PM_Data_Trend_Epic=new ProductData();
		    		CCW_PM_Data_Trend_Epic.title="Trend by Epic";
		    		...
		    		CCW_PM_Data_Trend_Epic.tableData.addColumn(new ColumnDescription("x", ValueType.TEXT, "Time"));
		    		CCW_PM_Data_Trend_Epic.tableData.addColumn(new ColumnDescription("y1", ValueType.INT, "Original Commitment"));
		    		...
		    		try 
		    		{
		    			CCW_PM_Data_Trend_Epic.tableData.addRows(rows);
		    		}catch(Exception e)
		    		{
	...
	{		
	    ...
	    try {
	    		...
	    		for(List<String> temp:Week_Result)
	    		{
		    		...
		    		CCW_PM_Data_Trend_Team=new ProductData();
		    		CCW_PM_Data_Trend_Team.title="Trend by Team";
		    		...
		    		CCW_PM_Data_Trend_Team.tableData.addColumn(new ColumnDescription("x", ValueType.TEXT, "Time"));
		    		CCW_PM_Data_Trend_Team.tableData.addColumn(new ColumnDescription("y1", ValueType.INT, "Original Commitment"));
		    		...
		    		try 
		    		{
		    			CCW_PM_Data_Trend_Team.tableData.addRows(rows);
		    		}
		    		catch(Exception e)
		    		{
		    			System.out.println("Import Exception!");
	...
	public static ProductData Get_CCW_PM_Data_Feature_Progress()
	{
...
/*	    		x1.clear();
	...
	{	
		...
		CCW_PM_Data_Weekly_Trend.title="CCW R11.01 Release Burnup";
		
		CCW_PM_Data_Weekly_Trend.description="";//description		
		CCW_PM_Data_Weekly_Trend.xTitle="Date";
		CCW_PM_Data_Weekly_Trend.yTitle="Number";
		CCW_PM_Data_Weekly_Trend.yAxisFormat="#";
		CCW_PM_Data_Weekly_Trend.tableData=new DataTable();
		CCW_PM_Data_Weekly_Trend.colorList=Arrays.asList(ColorFormater.RGB2String(130,175,94),ColorFormater.RGB2String(135,199,255));
		
		CCW_PM_Data_Weekly_Trend.tableData.addColumn(new ColumnDescription("x", ValueType.TEXT, "Time"));
		CCW_PM_Data_Weekly_Trend.tableData.addColumn(new ColumnDescription("y1", ValueType.INT, "Original Commitment"));
		CCW_PM_Data_Weekly_Trend.tableData.addColumn(new ColumnDescription("y2", ValueType.INT, "Story Points Finish"));
	...
	{	
		...
		CCW_PM_Data_ThroughputVelocity_sprint.title="Throughput - Velocity by Sprint";
		
		CCW_PM_Data_ThroughputVelocity_sprint.description="";//description		
		CCW_PM_Data_ThroughputVelocity_sprint.xTitle="Sprint";
		CCW_PM_Data_ThroughputVelocity_sprint.yTitle="Number";
		...
		CCW_PM_Data_ThroughputVelocity_sprint.tableData.addColumn(new ColumnDescription("y2", ValueType.INT, "Customer impact(24,16]"));
	...
	{	
		...
		CCW_PM_Data_Plan_Actual_Sprint.title="Plan vs Actual";
		
		CCW_PM_Data_Plan_Actual_Sprint.description="";//description		
		CCW_PM_Data_Plan_Actual_Sprint.xTitle="Sprint";
		CCW_PM_Data_Plan_Actual_Sprint.yTitle="Number";
		CCW_PM_Data_Plan_Actual_Sprint.yAxisFormat="#";
		CCW_PM_Data_Plan_Actual_Sprint.tableData=new DataTable();
		CCW_PM_Data_Plan_Actual_Sprint.colorList=Arrays.asList(ColorFormater.RGB2String(91,155,213),ColorFormater.RGB2String(237,125,49));
	...
	{	
		...
		CCW_PM_Data_Feature_Progress.title="all epic";
		CCW_PM_Data_Feature_Progress.description="";//description		
		CCW_PM_Data_Feature_Progress.xTitle="Epic";
		CCW_PM_Data_Feature_Progress.yTitle="Number";
		CCW_PM_Data_Feature_Progress.yAxisFormat="#";
		CCW_PM_Data_Feature_Progress.tableData=new DataTable();
		CCW_PM_Data_Feature_Progress.colorList=Arrays.asList(ColorFormater.RGB2String(112,173,71),ColorFormater.RGB2String(68,114,196));
		
		CCW_PM_Data_Feature_Progress.isStacked="true";
		CCW_PM_Data_Feature_Progress.chartLeft=400;

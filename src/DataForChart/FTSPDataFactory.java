...
public class FTSPDataFactory {
	...
	public static ProductData Get_FTSP_PM_Data_Weekly_Trend()
	{
		if(FTSP_PM_Data_Weekly_Trend==null)
		{
			ChartOfPM();
		}
		
		return FTSP_PM_Data_Weekly_Trend;
	}
	
	public static ProductData Get_FTSP_PM_Data_BurnDown()
	{
		if(FTSP_PM_Data_Weekly_BurnDown==null)
		{
			ChartOfPM();
		}
	...
	{
		if(FTSP_PM_Data_Feature_Progress==null)
		{
			ChartOfPM_About_Epic();
		}
		
		return FTSP_PM_Data_Feature_Progress;
	}
		
	
	public static ProductData FTSP_PM_Data_Weekly_Trend=null;
	public static ProductData FTSP_PM_Data_Weekly_BurnDown=null;
	public static ProductData FTSP_PM_Data_Trend_Epic=null;
	public static ProductData FTSP_PM_Data_Trend_Team=null;
	public static ProductData FTSP_PM_Data_ThroughputVelocity_sprint=null;
	public static ProductData FTSP_PM_Data_Plan_Actual_Sprint=null;
	public static ProductData FTSP_PM_Data_Feature_Progress=null;
	
	//public static List<String> EpicGroup=Arrays.asList("Some fancy multi-release feature","Ron's epic","[Technical Debt]");
	public static List<String> TeamGroup=Arrays.asList("FTSP Dalian Team","FTSP Team 2 (For Metrics Generation)");
	...
	{	
	    ...
	    for(int i = 0;i<iProcessAreas.size();i++)
		{
			...
			if(iProcessArea.getName().equals("CVB FTSP - RTC"))
			{
				nProjectNumber=i;
			}
				...
				for(int i=0;i<resultList.size();i++)
				 {
					...
					/*System.out.println(tempList4.get(0)+"\t"+tempList4.get(1)+"\t"+tempList4.get(2)+"\t"
							+tempList4.get(3)+"\t"+tempList4.get(4)+"\t"+tempList4.get(5)+"\t");*/
	...
	public static boolean Burn_Filter(String PlanFor,String Team)
	{
		...
		List<String> lstOtherTeam=Arrays.asList("CVB FTSP - RTC",
												"FTSP Team 2 (For Metrics Generation)");
	...
	{	
		...
		FTSP_PM_Data_Weekly_Trend.description="";//description		
		...
		try 
		{
			FTSP_PM_Data_Weekly_Trend.tableData.addRows(rows);
		}catch(Exception e)
		{
	...
	{	
		FTSP_PM_Data_Weekly_BurnDown=new ProductData();
		FTSP_PM_Data_Weekly_BurnDown.title=ConstString.FTSP_PM_CHART_Weekly_BurnDown;
		
		FTSP_PM_Data_Weekly_BurnDown.description="";//description		
		...
		try 
		{
			FTSP_PM_Data_Weekly_BurnDown.tableData.addRows(rows);
		}catch(Exception e)
		{
			System.out.println("Import Exception!");
		}
	...
	{	
		FTSP_PM_Data_ThroughputVelocity_sprint=new ProductData();
		FTSP_PM_Data_ThroughputVelocity_sprint.title=ConstString.CCW_PM_CHART_ThroughputVelocity_sprint;
		
		FTSP_PM_Data_ThroughputVelocity_sprint.description="";//description		
		FTSP_PM_Data_ThroughputVelocity_sprint.yTitle="Story Point";
		FTSP_PM_Data_ThroughputVelocity_sprint.yAxisFormat="#";
		FTSP_PM_Data_ThroughputVelocity_sprint.tableData=new DataTable();
		FTSP_PM_Data_ThroughputVelocity_sprint.colorList=Arrays.asList(ColorFormater.RGB2String(238,118,37),ColorFormater.RGB2String(91,155,213));
		
		FTSP_PM_Data_ThroughputVelocity_sprint.tableData.addColumn(new ColumnDescription("x", ValueType.TEXT, "Sprint"));
		FTSP_PM_Data_ThroughputVelocity_sprint.tableData.addColumn(new ColumnDescription("y1", ValueType.INT, "AVERAGE"));
		FTSP_PM_Data_ThroughputVelocity_sprint.tableData.addColumn(new ColumnDescription("y2", ValueType.INT, "Story Point"));
		...
		try 
		{
			FTSP_PM_Data_ThroughputVelocity_sprint.tableData.addRows(rows);
		}catch(Exception e)
		{
			System.out.println("Import Exception!");
		}
	...
	{	
		FTSP_PM_Data_Plan_Actual_Sprint=new ProductData();
		FTSP_PM_Data_Plan_Actual_Sprint.title=ConstString.FTSP_PM_CHART_Plan_Actual_Sprint;
		
		FTSP_PM_Data_Plan_Actual_Sprint.description="";//description		
		FTSP_PM_Data_Plan_Actual_Sprint.yTitle="Story Point";
		FTSP_PM_Data_Plan_Actual_Sprint.yAxisFormat="#";
		FTSP_PM_Data_Plan_Actual_Sprint.tableData=new DataTable();
		FTSP_PM_Data_Plan_Actual_Sprint.colorList=Arrays.asList("green",ColorFormater.RGB2String(91,155,213),ColorFormater.RGB2String(237,125,49));

		
		FTSP_PM_Data_Plan_Actual_Sprint.tableData.addColumn(new ColumnDescription("x", ValueType.TEXT, "Time"));
		FTSP_PM_Data_Plan_Actual_Sprint.tableData.addColumn(new ColumnDescription("y3", ValueType.INT, "Average"));
		FTSP_PM_Data_Plan_Actual_Sprint.tableData.addColumn(new ColumnDescription("y1", ValueType.INT, "Planned"));
		FTSP_PM_Data_Plan_Actual_Sprint.tableData.addColumn(new ColumnDescription("y2", ValueType.INT, "Actual"));
		...
		try 
		{
			FTSP_PM_Data_Plan_Actual_Sprint.tableData.addRows(rows);
		}catch(Exception e)
		{
			System.out.println("Import Exception!");
		}
	...
	{	
		...
		FTSP_PM_Data_Feature_Progress.description="";//description		
	//	FTSP_PM_Data_Feature_Progress.yTitle="Story Point";
		FTSP_PM_Data_Feature_Progress.yAxisFormat="#";
		FTSP_PM_Data_Feature_Progress.tableData=new DataTable();
		...
		FTSP_PM_Data_Feature_Progress.tableData.addColumn(new ColumnDescription("y2", ValueType.INT, "Remain"));
		FTSP_PM_Data_Feature_Progress.tableData.addColumn(new ColumnDescription("y3", ValueType.INT, "Risk"));
		...
		try 
		{
			FTSP_PM_Data_Feature_Progress.tableData.addRows(rows);
		}catch(Exception e)
		{
			System.out.println("Import Exception!");
		}
	...
	{			    	    
		...
		FTSP_PM_Data_Trend_Team=new ProductData();
		FTSP_PM_Data_Trend_Team.title="Trend by Team";
		
		FTSP_PM_Data_Trend_Team.description="";//description		
		FTSP_PM_Data_Trend_Team.yTitle="Story Point";
		FTSP_PM_Data_Trend_Team.yAxisFormat="#";
		FTSP_PM_Data_Trend_Team.tableData=new DataTable();
		FTSP_PM_Data_Trend_Team.colorList=Arrays.asList(ColorFormater.RGB2String(158,158,158));
		
		FTSP_PM_Data_Trend_Team.tableData.addColumn(new ColumnDescription("x", ValueType.TEXT, "Time"));
		FTSP_PM_Data_Trend_Team.tableData.addColumn(new ColumnDescription("y1", ValueType.INT, TeamLine.get(0).EpicName));
		FTSP_PM_Data_Trend_Team.tableData.addColumn(new ColumnDescription("y2", ValueType.INT, TeamLine.get(1).EpicName));
		FTSP_PM_Data_Trend_Team.tableData.addColumn(new ColumnDescription("y3", ValueType.INT, TeamLine.get(2).EpicName));
		FTSP_PM_Data_Trend_Team.tableData.addColumn(new ColumnDescription("y4", ValueType.INT, TeamLine.get(3).EpicName));
		FTSP_PM_Data_Trend_Team.tableData.addColumn(new ColumnDescription("y5", ValueType.INT, TeamLine.get(4).EpicName));
		FTSP_PM_Data_Trend_Team.tableData.addColumn(new ColumnDescription("y6", ValueType.INT, TeamLine.get(5).EpicName));
		FTSP_PM_Data_Trend_Team.tableData.addColumn(new ColumnDescription("y7", ValueType.INT, TeamLine.get(6).EpicName));
		FTSP_PM_Data_Trend_Team.tableData.addColumn(new ColumnDescription("y8", ValueType.INT, TeamLine.get(7).EpicName));
		FTSP_PM_Data_Trend_Team.tableData.addColumn(new ColumnDescription("y9", ValueType.INT, TeamLine.get(8).EpicName));
		FTSP_PM_Data_Trend_Team.tableData.addColumn(new ColumnDescription("y10", ValueType.INT, TeamLine.get(9).EpicName));
		FTSP_PM_Data_Trend_Team.tableData.addColumn(new ColumnDescription("y11", ValueType.INT, TeamLine.get(10).EpicName));
		...
		try 
		{
			FTSP_PM_Data_Trend_Team.tableData.addRows(rows);
		}
		catch(Exception e)
		{
			System.out.println("Import Exception!");
